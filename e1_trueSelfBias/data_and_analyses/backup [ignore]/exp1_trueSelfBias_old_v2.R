...
####============================ plot - forced choice data ===============================

accuracyTable <- matrix(NA,3,2)
rownames(accuracyTable) <- c('White','Arab Immigrant','Arab Native')
...
barplot(accuracyTable, beside=TRUE,ylim=c(0,1.0), col=c("red", "green", "blue"),
        legend.text=TRUE, ylab="Proportion of Participants Attributing Change to True Self",main="True Self Forced Choice Items")
